...
namespace lojacarros.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarroId,nome,marca")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarroId,nome,marca")] Carro carro)
        {
            if (id != carro.CarroId)
            {
                return NotFound();
